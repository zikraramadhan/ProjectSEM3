...
--
-- Host: localhost:3306
-- Generation Time: Jan 02, 2024 at 03:58 PM
...
INSERT INTO `pengaduan` (`id_laporan`, `nama`, `judul_laporan`, `no_hp`, `lokasi`, `tanggal_kejadian`, `detail`, `status`) VALUES
(1, 'rosalinda', 'kekerasn fisik', '68537603', 'dumai,purnama', '2023-12-05', 'jbfajbgajgbajkgb', 'Diterima');
...
CREATE TABLE `psikolog` (
  ...
  `nama` varchar(50) NOT NULL,
  `spesialis` varchar(50) NOT NULL DEFAULT 'psikolog klinis'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `psikolog` (`id_psikolog`, `nama`, `spesialis`) VALUES
(1, 'tes', 'ini spesialis');
...
(7, 'ZIKRA RAMADHAN', '2004-11-13', 'laki-laki', 'ramadhan22ti@mahasiswa.pcr.ac.id', '', 'user', '2024-01-02 14:22:54'),
(8, 'ZIKRA RAMADHAN', '2023-11-21', 'laki-laki', 'ramadhan22ti@mahasiswa.pcr.ac.id', '', 'user', '2024-01-02 14:22:57'),
(9, 'zikra', '2023-11-21', 'laki-laki', 'zikra@gmail.com', '', 'user', '2024-01-02 14:22:59'),
(10, 'Jabal', '2023-11-18', 'laki-laki', 'jabal@gmail.com', '', 'user', '2024-01-02 14:23:00'),
(11, 'ayas', '2004-07-07', 'perempuan', 'yayas@gmail.com', '', 'User', '2024-01-02 14:23:02'),
(12, 'Adminstrator', '2024-01-01', 'perempuan', 'admin@gmail.com', '$2a$12$x27RdKugbe2j7S0jdkw95.BhYSnxkKcfaTLwPmejN1AuyEmPGHwQS', 'admin', '2024-01-02 14:23:59');
...
--
ALTER TABLE `psikolog`
  MODIFY `id_psikolog` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
